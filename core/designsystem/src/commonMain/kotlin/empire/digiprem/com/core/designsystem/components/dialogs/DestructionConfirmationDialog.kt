...
@Composable
fun DestructionConfirmationDialog(
    title:String,
    description:String,
    confirmationButtonText:String,
    cancelButtonsText:String,
    onConfirmClick:()->Unit,
    onCancelClick:()->Unit,
    onDismiss:()->Unit,
) {
...
@Preview
@Composable
fun DestructionConfirmationDialogPreview(){
    ChirpTheme(darkTheme = true) {
        DestructionConfirmationDialog(
            title = "Delete profile picture",
            description="this will permanently delete your profile",
            confirmationButtonText = "Delete",
            cancelButtonsText = "Cancel",
            onConfirmClick = {},
            onDismiss = {},
            onCancelClick = {}
        )
