...
import platform.Network.nw_ws_response_get_status
...
actual class ConnectivityObserver {
    actual val isConnected: Flow<Boolean> =  callbackFlow {
        ...
        nw_path_monitor_set_update_handler(pathMonitor){path->
            if (path != null) {
                val status= nw_ws_response_get_status(path)
    ...
    companion object{
        private const val NW_PATH_MONITOR_LABEL = "empire.digiprem.com.chat.data.network.ConnectivityObserver"
    }
